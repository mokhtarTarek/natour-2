...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidGFyZWstbW9raHRhciIsImEiOiJja3d5MHNlYm8waWYwMzRxdHZ5c2o3MHRtIn0.zAUnjJNZ6gx1UVPI9r8bAA';
...
var stripe = Stripe('pk_test_51K8qpdI4i3Bqw2PHwgUFTdcwCVwGXKGlZgS34UM1keQu0FnAnwQpIzDGzBNeYgJVPDvYJoKPa0cHRosgweVvn6e4005tTzsVRx');
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    e.target.textContent = 'Processing...'; //the tourId come from the button (data-tour-id=`${tour.id}`)
